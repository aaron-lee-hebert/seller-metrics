...
{
    /// <inheritdoc />
    public partial class AddWaveIntegration : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    WaveInvoiceId = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: false),
                    InvoiceNumber = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: false),
                    CustomerName = table.Column<string>(type: "character varying(255)", maxLength: 255, nullable: false),
                    WaveCustomerId = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_WaveInvoices", x => x.Id);
                    table.ForeignKey(
                        name: "FK_WaveInvoices_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    WaveBusinessId = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: false),
                    WaveBusinessName = table.Column<string>(type: "character varying(255)", maxLength: 255, nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_WaveUserCredentials", x => x.Id);
                    table.ForeignKey(
                        name: "FK_WaveUserCredentials_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    UserId = table.Column<string>(type: "character varying(450)", maxLength: 450, nullable: false),
                    WavePaymentId = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: false),
                    WaveInvoiceId = table.Column<int>(type: "integer", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_WavePayments", x => x.Id);
                    table.ForeignKey(
                        name: "FK_WavePayments_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_WavePayments_WaveInvoices_WaveInvoiceId",
                        column: x => x.WaveInvoiceId,
                        principalTable: "WaveInvoices",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2025, 12, 1, 22, 18, 39, 864, DateTimeKind.Utc).AddTicks(6477), "Parts & Materials", null, "Random Access Memory modules", false, true, "RAM", 1, null },
                    { 2, new DateTime(2025, 12, 1, 22, 18, 39, 864, DateTimeKind.Utc).AddTicks(7666), "Parts & Materials", null, "Solid State Drives", false, true, "SSD", 2, null },
                    { 3, new DateTime(2025, 12, 1, 22, 18, 39, 864, DateTimeKind.Utc).AddTicks(7668), "Parts & Materials", null, "Hard Disk Drives", false, true, "HDD", 3, null },
                    { 4, new DateTime(2025, 12, 1, 22, 18, 39, 864, DateTimeKind.Utc).AddTicks(7669), "Parts & Materials", null, "Power Supply Units (PSU)", false, true, "Power Supply", 4, null },
                    { 5, new DateTime(2025, 12, 1, 22, 18, 39, 864, DateTimeKind.Utc).AddTicks(7671), "Parts & Materials", null, "Central Processing Units", false, true, "CPU", 5, null },
                    { 6, new DateTime(2025, 12, 1, 22, 18, 39, 864, DateTimeKind.Utc).AddTicks(7672), "Parts & Materials", null, "System motherboards", false, true, "Motherboard", 6, null },
                    { 7, new DateTime(2025, 12, 1, 22, 18, 39, 864, DateTimeKind.Utc).AddTicks(7673), "Parts & Materials", null, "GPUs and video cards", false, true, "Graphics Card", 7, null },
                    { 8, new DateTime(2025, 12, 1, 22, 18, 39, 864, DateTimeKind.Utc).AddTicks(7675), "Parts & Materials", null, "Network interface cards and adapters", false, true, "Network Card", 8, null },
                    { 9, new DateTime(2025, 12, 1, 22, 18, 39, 864, DateTimeKind.Utc).AddTicks(7676), "Parts & Materials", null, "Fans, heatsinks, and cooling systems", false, true, "Cooling", 9, null },
                    { 10, new DateTime(2025, 12, 1, 22, 18, 39, 864, DateTimeKind.Utc).AddTicks(7677), "Parts & Materials", null, "Computer cases and enclosures", false, true, "Case", 10, null },
                    { 11, new DateTime(2025, 12, 1, 22, 18, 39, 864, DateTimeKind.Utc).AddTicks(7678), "Parts & Materials", null, "Cables and connectors", false, true, "Cables", 11, null },
                    { 12, new DateTime(2025, 12, 1, 22, 18, 39, 864, DateTimeKind.Utc).AddTicks(7680), "Parts & Materials", null, "Keyboards, mice, and other peripherals", false, true, "Peripherals", 12, null },
                    { 13, new DateTime(2025, 12, 1, 22, 18, 39, 864, DateTimeKind.Utc).AddTicks(7681), "Parts & Materials", null, "Other components", false, true, "Other", 99, null }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_WaveInvoices_InvoiceDate",
                table: "WaveInvoices",
                column: "InvoiceDate");

            migrationBuilder.CreateIndex(
                name: "IX_WaveInvoices_Status",
                table: "WaveInvoices",
                column: "Status");

            migrationBuilder.CreateIndex(
                name: "IX_WaveInvoices_UserId",
                table: "WaveInvoices",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_WaveInvoices_UserId_WaveInvoiceId",
                table: "WaveInvoices",
                columns: new[] { "UserId", "WaveInvoiceId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_WavePayments_PaymentDate",
                table: "WavePayments",
                column: "PaymentDate");

            migrationBuilder.CreateIndex(
                name: "IX_WavePayments_UserId",
                table: "WavePayments",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_WavePayments_UserId_WavePaymentId",
                table: "WavePayments",
                columns: new[] { "UserId", "WavePaymentId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_WavePayments_WaveInvoiceId",
                table: "WavePayments",
                column: "WaveInvoiceId");

            migrationBuilder.CreateIndex(
                name: "IX_WaveUserCredentials_UserId",
                table: "WaveUserCredentials",
                column: "UserId",
                unique: true);
        }
