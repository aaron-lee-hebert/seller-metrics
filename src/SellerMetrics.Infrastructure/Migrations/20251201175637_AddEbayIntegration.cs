        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EbayUserId = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: true),
                    EbayUsername = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    UserId = table.Column<string>(type: "character varying(450)", maxLength: 450, nullable: false),
                    EbayOrderId = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: false),
                    LegacyOrderId = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: true),
                    ...
                    EbayItemId = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: true),
                    Sku = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: true),
                    Quantity = table.Column<int>(type: "integer", nullable: false),
                    GrossSaleAmount = table.Column<decimal>(type: "numeric(18,2)", nullable: false),
                    GrossSaleCurrency = table.Column<string>(type: "character varying(3)", maxLength: 3, nullable: false, defaultValue: "USD"),
                    ShippingPaidAmount = table.Column<decimal>(type: "numeric(18,2)", nullable: false),
                    ShippingPaidCurrency = table.Column<string>(type: "character varying(3)", maxLength: 3, nullable: false, defaultValue: "USD"),
                    ShippingActualAmount = table.Column<decimal>(type: "numeric(18,2)", nullable: false),
                    ShippingActualCurrency = table.Column<string>(type: "character varying(3)", maxLength: 3, nullable: false, defaultValue: "USD"),
                    FinalValueFeeAmount = table.Column<decimal>(type: "numeric(18,2)", nullable: false),
                    FinalValueFeeCurrency = table.Column<string>(type: "character varying(3)", maxLength: 3, nullable: false, defaultValue: "USD"),
                    PaymentProcessingFeeAmount = table.Column<decimal>(type: "numeric(18,2)", nullable: false),
                    PaymentProcessingFeeCurrency = table.Column<string>(type: "character varying(3)", maxLength: 3, nullable: false, defaultValue: "USD"),
                    AdditionalFeesAmount = table.Column<decimal>(type: "numeric(18,2)", nullable: false),
                    AdditionalFeesCurrency = table.Column<string>(type: "character varying(3)", maxLength: 3, nullable: false, defaultValue: "USD"),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2025, 12, 1, 17, 56, 36, 622, DateTimeKind.Utc).AddTicks(7697), "Parts & Materials", null, "Random Access Memory modules", false, true, "RAM", 1, null },
                    { 2, new DateTime(2025, 12, 1, 17, 56, 36, 622, DateTimeKind.Utc).AddTicks(8374), "Parts & Materials", null, "Solid State Drives", false, true, "SSD", 2, null },
                    { 3, new DateTime(2025, 12, 1, 17, 56, 36, 622, DateTimeKind.Utc).AddTicks(8376), "Parts & Materials", null, "Hard Disk Drives", false, true, "HDD", 3, null },
                    { 4, new DateTime(2025, 12, 1, 17, 56, 36, 622, DateTimeKind.Utc).AddTicks(8378), "Parts & Materials", null, "Power Supply Units (PSU)", false, true, "Power Supply", 4, null },
                    { 5, new DateTime(2025, 12, 1, 17, 56, 36, 622, DateTimeKind.Utc).AddTicks(8379), "Parts & Materials", null, "Central Processing Units", false, true, "CPU", 5, null },
                    { 6, new DateTime(2025, 12, 1, 17, 56, 36, 622, DateTimeKind.Utc).AddTicks(8380), "Parts & Materials", null, "System motherboards", false, true, "Motherboard", 6, null },
                    { 7, new DateTime(2025, 12, 1, 17, 56, 36, 622, DateTimeKind.Utc).AddTicks(8381), "Parts & Materials", null, "GPUs and video cards", false, true, "Graphics Card", 7, null },
                    { 8, new DateTime(2025, 12, 1, 17, 56, 36, 622, DateTimeKind.Utc).AddTicks(8382), "Parts & Materials", null, "Network interface cards and adapters", false, true, "Network Card", 8, null },
                    { 9, new DateTime(2025, 12, 1, 17, 56, 36, 622, DateTimeKind.Utc).AddTicks(8383), "Parts & Materials", null, "Fans, heatsinks, and cooling systems", false, true, "Cooling", 9, null },
                    { 10, new DateTime(2025, 12, 1, 17, 56, 36, 622, DateTimeKind.Utc).AddTicks(8384), "Parts & Materials", null, "Computer cases and enclosures", false, true, "Case", 10, null },
                    { 11, new DateTime(2025, 12, 1, 17, 56, 36, 622, DateTimeKind.Utc).AddTicks(8385), "Parts & Materials", null, "Cables and connectors", false, true, "Cables", 11, null },
                    { 12, new DateTime(2025, 12, 1, 17, 56, 36, 622, DateTimeKind.Utc).AddTicks(8386), "Parts & Materials", null, "Keyboards, mice, and other peripherals", false, true, "Peripherals", 12, null },
                    { 13, new DateTime(2025, 12, 1, 17, 56, 36, 622, DateTimeKind.Utc).AddTicks(8387), "Parts & Materials", null, "Other components", false, true, "Other", 99, null }
                });
